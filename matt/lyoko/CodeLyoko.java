...
public class CodeLyoko {
    ...
    // public static int TEST_DIMENSION_ID_THINGY_THAT_IS_NOT_USED =
    ...
    public static final BiomeGenBase lyokoMountainBiome = ((BiomeGenBaseLyoko) new BiomeGenMountainSector(9).setColor(8421631)).setLyokoBiomeName("Mountain Sector");
    public static final BiomeGenBase lyokoForestBiome = ((BiomeGenBaseLyoko) new BiomeGenForestSector(10).setColor(8421631)).setLyokoBiomeName("Forest Sector");
    public static final BiomeGenBase lyokoDesertBiome = ((BiomeGenBaseLyoko) new BiomeGenDesertSector(11).setColor(8421631)).setLyokoBiomeName("Desert Sector");
    public static final BiomeGenBase lyokoPolarBiome = ((BiomeGenBaseLyoko) new BiomeGenPolarSector(12).setColor(8421631)).setLyokoBiomeName("Polar Sector");
    public static final BiomeGenBase lyokoCarthageBiome = ((BiomeGenBaseLyoko) new BiomeGenCarthageSector(13).setColor(8421631)).setLyokoBiomeName("Carthage Sector");
    
    public static Item Katana;// = new ItemLyokoSword(Weapon_Lyoko_1,
                              // toolLYOKO).setUnlocalizedName("Katana").setIconIndex(0);
    public static Item Zweihander;// = new ItemLyokoSword(Weapon_Lyoko_2,
                                  // toolLYOKO).setUnlocalizedName("Zweihander").setIconIndex(1);
    public static Item Fan;// = new
                           // ItemLyokoFan(Weapon_Lyoko_3).setUnlocalizedName("Fan").setIconIndex(2);
    public static Item EnergyField;// = new
                                   // ItemLyokoEnergyField(Weapon_Lyoko_4).setUnlocalizedName("EnergyField").setIconIndex(3);
    public static Item Glove;// = new
                             // ItemGlove(Weapon_Lyoko_5).setUnlocalizedName("Glove").setIconIndex(4);
    public static Item LaserArrow;// = new
                                  // ItemLyoko(Weapon_Lyoko_6).setUnlocalizedName("LaserArrow").setIconIndex(5);
    public static Item LyokoIngot;// = new
                                  // ItemLyoko(Item_Lyoko_11).setUnlocalizedName("LyokoIngot").setIconIndex(16);
    public static Item LyokoLead;// = new
                                 // ItemLyoko(Item_Lyoko_12).setUnlocalizedName("Lead210").setIconIndex(17);
    public static Item LyokoCell;// = new
                                 // ItemLyoko(Item_Lyoko_13).setUnlocalizedName("Cell").setIconIndex(18);
    public static Item LyokoLeadCell;// = new ItemLyokoFuel(Item_Lyoko_14,
                                     // 10000).setUnlocalizedName("Lead210Cell").setIconIndex(19);
    public static Item LyokoDepletedLeadCell;// = new
                                             // ItemLyoko(Item_Lyoko_15).setUnlocalizedName("DepletedLead210Cell").setIconIndex(20);
    public static Item AelitaHelmet;// = new ArmorLyoko(Aelita_Armor_Helmet,
                                    // armorLYOKO, 5, 0,
                                    // "Aelita").setIconIndex(21).setUnlocalizedName("AelitaHelmet");
    public static Item AelitaChest;// = new ArmorLyoko(Aelita_Armor_Chest,
                                   // armorLYOKO, 5, 1,
                                   // "Aelita").setIconIndex(22).setUnlocalizedName("AelitaChest");
    public static Item AelitaLegs;// = new ArmorLyoko(Aelita_Armor_Pants,
                                  // armorLYOKO, 5, 2,
                                  // "Aelita").setIconIndex(23).setUnlocalizedName("AelitaPants");
    public static Item AelitaBoots;// = new ArmorLyoko(Aelita_Armor_Boots,
                                   // armorLYOKO, 5, 3,
                                   // "Aelita").setIconIndex(24).setUnlocalizedName("AelitaBoots");
    public static Item OddHelmet;// = new ArmorLyoko(Odd_Armor_Helmet,
                                 // armorLYOKO, 6, 0,
                                 // "Odd").setIconIndex(25).setUnlocalizedName("OddHelmet");
    public static Item OddChest;// = new ArmorLyoko(Odd_Armor_Chest, armorLYOKO,
                                // 6, 1,
                                // "Odd").setIconIndex(26).setUnlocalizedName("OddChest");
    public static Item OddLegs;// = new ArmorLyoko(Odd_Armor_Pants, armorLYOKO,
                               // 6, 2,
                               // "Odd").setIconIndex(27).setUnlocalizedName("OddPants");
    public static Item OddBoots;// = new ArmorLyoko(Odd_Armor_Boots, armorLYOKO,
                                // 6, 3,
                                // "Odd").setIconIndex(28).setUnlocalizedName("OddBoots");
    public static Item UlrichHelmet;// = new ArmorLyoko(Ulrich_Armor_Helmet,
                                    // armorLYOKO, 7, 0,
                                    // "Ulrich").setIconIndex(29).setUnlocalizedName("UlrichHelmet");
    public static Item UlrichChest;// = new ArmorLyoko(Ulrich_Armor_Chest,
                                   // armorLYOKO, 7, 1,
                                   // "Ulrich").setIconIndex(30).setUnlocalizedName("UlrichChest");
    public static Item UlrichLegs;// = new ArmorLyoko(Ulrich_Armor_Pants,
                                  // armorLYOKO, 7, 2,
                                  // "Ulrich").setIconIndex(31).setUnlocalizedName("UlrichPants");
    public static Item UlrichBoots;// = new ArmorLyoko(Ulrich_Armor_Boots,
                                   // armorLYOKO, 7, 3,
                                   // "Ulrich").setIconIndex(32).setUnlocalizedName("UlrichBoots");
    public static Item YumiHelmet;// = new ArmorLyoko(Yumi_Armor_Helmet,
                                  // armorLYOKO, 8, 0,
                                  // "Yumi").setIconIndex(33).setUnlocalizedName("YumiHelmet");
    public static Item YumiChest;// = new ArmorLyoko(Yumi_Armor_Chest,
                                 // armorLYOKO, 8, 1,
                                 // "Yumi").setIconIndex(34).setUnlocalizedName("YumiChest");
    public static Item YumiLegs;// = new ArmorLyoko(Yumi_Armor_Pants,
                                // armorLYOKO, 8, 2,
                                // "Yumi").setIconIndex(35).setUnlocalizedName("YumiPants");
    public static Item YumiBoots;// = new ArmorLyoko(Yumi_Armor_Boots,
                                 // armorLYOKO, 8, 3,
                                 // "Yumi").setIconIndex(36).setUnlocalizedName("YumiBoots");
    public static Item WilliamHelmet;// = new ArmorLyoko(William_Armor_Helmet,
                                     // armorLYOKO, 9, 0,
                                     // "William").setIconIndex(37).setUnlocalizedName("WilliamHelmet");
    public static Item WilliamChest;// = new ArmorLyoko(William_Armor_Chest,
                                    // armorLYOKO, 9, 1,
                                    // "William").setIconIndex(38).setUnlocalizedName("WilliamChest");
    public static Item WilliamLegs;// = new ArmorLyoko(William_Armor_Pants,
                                   // armorLYOKO, 9, 2,
                                   // "William").setIconIndex(39).setUnlocalizedName("WilliamPants");
    public static Item WilliamBoots;// = new ArmorLyoko(William_Armor_Boots,
                                    // armorLYOKO, 9, 3,
                                    // "William").setIconIndex(40).setUnlocalizedName("WilliamBoots");
    ...
    public static Block DigitalSeaFlowing;// = new
    ...
    public static Block DigitalSeaStill;// = new
                                        // BlockStationaryDigitalSea(Lyoko_Sea_Still,
                                        // Material.water).setHardness(100F).setLightOpacity(3).setUnlocalizedName("DigitalSeaStill").setRequiresSelfNotify();
    ...
    public static CommonProxy proxy; // This object will be populated with the
                                     ...
                                     // environment
    // the instance that forge and the mod uses.
    @Instance
    ...
    public void CodeLyokoLoad(FMLInitializationEvent evt) {
        ...
        // Marq = Odd
        // Andrew = Odd (Jeremy)
        proxy.registerRenderInformation(); // You have to call the methods in
                                           // your proxy class
        ...
        GameRegistry.addRecipe(new ItemStack(SuperCalc, 1), new Object[] { "###", "#*#", "###", Character.valueOf('#'), Block.blockGold, Character.valueOf('*'), Item.netherStar });
         ...
         * Item.netherStar, Character.valueOf('$'), DataFragment,
         * Character.valueOf('h'), OddHelmet, Character.valueOf('c'), OddChest,
         * Character.valueOf('l'), OddLegs, Character.valueOf('b'), OddBoots });
         */

        LanguageRegistry.addName(Skid, "Skidbladnir");
        /*
         * GameRegistry.addRecipe(new ItemStack(Skid, 1), new Object[] { "h*c",
         * "$#$", "bml", Character.valueOf('*'), Item.boat,
         * Character.valueOf('m'), Item.minecartEmpty, Character.valueOf('#'),
         * Item.netherStar, Character.valueOf('$'), DataFragment,
         * Character.valueOf('h'), OddHelmet, Character.valueOf('c'), OddChest,
         * Character.valueOf('l'), OddLegs, Character.valueOf('b'), OddBoots });
        ...
        GameRegistry.addRecipe(new ItemStack(LyokoCell, 16), new Object[] { " # ", "#*#", " # ", Character.valueOf('*'), Block.glass, Character.valueOf('#'), Item.ingotIron });
        GameRegistry.addShapelessRecipe(new ItemStack(LyokoCell, 1), new Object[] { LyokoDepletedLeadCell });
        ...
        GameRegistry.addRecipe(new ItemStack(AelitaHelmet, 1), new Object[] { "***", "*#*", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 9) });
        GameRegistry.addRecipe(new ItemStack(AelitaChest, 1), new Object[] { "*#*", "***", "***", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 9) });
        GameRegistry.addRecipe(new ItemStack(AelitaLegs, 1), new Object[] { "***", "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 9) });
        GameRegistry.addRecipe(new ItemStack(AelitaBoots, 1), new Object[] { "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 9) });
        ...
        GameRegistry.addRecipe(new ItemStack(OddHelmet, 1), new Object[] { "***", "*#*", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 13) });
        GameRegistry.addRecipe(new ItemStack(OddChest, 1), new Object[] { "*#*", "***", "***", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 13) });
        GameRegistry.addRecipe(new ItemStack(OddLegs, 1), new Object[] { "***", "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 13) });
        GameRegistry.addRecipe(new ItemStack(OddBoots, 1), new Object[] { "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 13) });
        ...
        GameRegistry.addRecipe(new ItemStack(UlrichHelmet, 1), new Object[] { "***", "*#*", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 11) });
        GameRegistry.addRecipe(new ItemStack(UlrichChest, 1), new Object[] { "*#*", "***", "***", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 11) });
        GameRegistry.addRecipe(new ItemStack(UlrichLegs, 1), new Object[] { "***", "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 11) });
        GameRegistry.addRecipe(new ItemStack(UlrichBoots, 1), new Object[] { "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 11) });
        ...
        GameRegistry.addRecipe(new ItemStack(YumiHelmet, 1), new Object[] { "***", "*#*", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 5) });
        GameRegistry.addRecipe(new ItemStack(YumiChest, 1), new Object[] { "*#*", "***", "***", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 5) });
        GameRegistry.addRecipe(new ItemStack(YumiLegs, 1), new Object[] { "***", "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 5) });
        GameRegistry.addRecipe(new ItemStack(YumiBoots, 1), new Object[] { "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 5) });
        ...
        GameRegistry.addRecipe(new ItemStack(WilliamHelmet, 1), new Object[] { "***", "*#*", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 12) });
        GameRegistry.addRecipe(new ItemStack(WilliamChest, 1), new Object[] { "*#*", "***", "***", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 12) });
        GameRegistry.addRecipe(new ItemStack(WilliamLegs, 1), new Object[] { "***", "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 12) });
        GameRegistry.addRecipe(new ItemStack(WilliamBoots, 1), new Object[] { "*#*", "* *", Character.valueOf('*'), LyokoIngot, Character.valueOf('#'), new ItemStack(Item.dyePowder, 1, 12) });

        LanguageRegistry.addName(Katana, "Katana");
        /*
         * GameRegistry.addRecipe(new ItemStack(Katana, 1), new Object[] {
         * " * ", " * ", " # ", Character.valueOf('*'), LyokoIngot,
        ...
        /*
         * GameRegistry.addRecipe(new ItemStack(Fan, 1), new Object[] { "#f ",
         * "#*f", "###", Character.valueOf('*'), LyokoIngot,
         * Character.valueOf('#'), Item.stick, Character.valueOf('f'),
         * Item.feather });
         */
         ...
         * "#a#", "#*#", Character.valueOf('*'), LyokoIngot,
         * Character.valueOf('#'), Item.leather, Character.valueOf('a'),
         * LaserArrow });
         */
         ...
         * "a*a", "*#*", "a*a", Character.valueOf('*'), LyokoIngot,
         * Character.valueOf('#'), Item.netherStar, Character.valueOf('a'),
         * Item.arrow });
         */
        ...
        // test recipes
        // GameRegistry.addShapelessRecipe(new ItemStack(DigitalSeaBlock, 10),
        // new Object[] {
        // Block.dirt
        // });

        // register your entities here
        // params are entClass, entName, ID, mod, trackingRange,
        // updateFrequency, sendVelocityUpdates //just like before, just called
        // differently
        /*
         * //LanguageRegistry.instance().addStringLocalization(
         * "entity.Elephant.name", "en_US", "Elephant");
         * //EntityRegistry.registerGlobalEntityID(EntityElephant.class,
         * "Elephant", EntityRegistry.findGlobalUniqueEntityId());
         */
        // last param is entity ID, must be unique
        // seems that the vanilla entities now occupy most slots between
        // 0-110'ish
        ...
        // EntityRegistry.addSpawn(matt.lyoko.entities.EntitySkid.class, 0, 0,
        // 1, EnumCreatureType.creature, lyokocarthage);
        /*
         * EntityRegistry.addSpawn(net.minecraft.src.lyoko.EntityHornet.class,
         * 10, 3, 15, EnumCreatureType.monster, lyokocarthage, lyokoforest,
         * lyokomountain, lyokopolar, lyokodesert);
         * EntityRegistry.addSpawn(net.minecraft
         * .src.lyoko.EntityKankrelat.class, 10, 3, 15,
         * EnumCreatureType.monster, lyokocarthage, lyokoforest, lyokomountain,
         * lyokopolar, lyokodesert);
         * EntityRegistry.addSpawn(net.minecraft.src.lyoko.EntityKrab.class, 10,
         * 3, 15, EnumCreatureType.monster, lyokocarthage, lyokoforest,
         * lyokomountain, lyokopolar, lyokodesert);
         * EntityRegistry.addSpawn(net.minecraft
         * .src.lyoko.EntityLyokoCreeper.class, 10, 3, 15,
         * EnumCreatureType.monster, lyokocarthage, lyokoforest, lyokomountain,
         * lyokopolar, lyokodesert);
         * EntityRegistry.addSpawn(net.minecraft.src.lyoko.EntityManta.class,
         * 10, 3, 15, EnumCreatureType.monster, lyokocarthage, lyokoforest,
         * lyokomountain, lyokopolar, lyokodesert);
         * EntityRegistry.addSpawn(net.minecraft
         * .src.lyoko.EntityTarantula.class, 10, 3, 15,
         * EnumCreatureType.monster, lyokocarthage, lyokoforest, lyokomountain,
         * lyokopolar, lyokodesert);
         */
    }
    ...
    public void CodeLyokoPreLoad(FMLPreInitializationEvent preevt) {
        ...
        /**
         * taken from my other mod so I can add booleans if needed to the config
         * file
         */
        // canCraftMoney = config.get(Configuration.CATEGORY_GENERAL,
        // "canCraftMoney", true).getBoolean(true);
