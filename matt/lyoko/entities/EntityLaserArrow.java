...
public class EntityLaserArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityLaserArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLaserArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityLaserArrow(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = CodeLyoko.causeLaserArrowDamage(this, this);
                    }
                    else
                    {
                        var21 = CodeLyoko.causeLaserArrowDamage(this, this.shootingEntity);
                    }
