...
public class ItemOverboard extends Item
{
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        MovingObjectPosition var24 = par2World.rayTraceBlocks_do_do(var13, var23, true, false);
        ...
        else
        {
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityOverboard var35 = new EntityOverboard(par2World, (double)((float)var29 + 0.5F), (double)((float)var33 + 1.0F), (double)((float)var34 + 0.5F));
