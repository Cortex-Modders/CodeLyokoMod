...
public class ItemLyokoEnergyField extends Item
{       
    public ItemLyokoEnergyField(int id)
    {
        super(id);
        maxStackSize = 1;
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (var5 || par3EntityPlayer.inventory.hasItem(CodeLyoko.EnergyField.itemID))
        {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(CodeLyoko.EnergyField.itemID))
        {
