...
public class ModelGlove extends ModelBase {
    ...
    public ModelGlove() {
        ...
        finger3mid.addBox(0.0F, -0.7F, -1.5F, 1, 1, 1);
        finger3mid.setRotationPoint(-0.5F, 0.545F, -1.4F);
        ...
        finger3tip.setRotationPoint(0.5F, -0.25F, -1.4F);
    ...
    public void clenchHand() {
        ...
        finger3.rotateAngleX = (float)Math.toRadians(30);
        finger3mid.rotateAngleX = (float)Math.toRadians(30);
        finger3tip.rotateAngleX = (float)Math.toRadians(30);
    }
