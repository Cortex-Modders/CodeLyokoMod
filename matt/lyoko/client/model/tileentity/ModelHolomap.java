...
public class ModelHolomap extends ModelBase
{
	...
	public ModelHolomap()
	{
		...
		edge1.addBox(-1F, 0F, -8F, 2, 8, 14);
		edge1.setRotationPoint(-7F, 8F, 0F);
		edge1.setTextureSize(64, 128);
		edge1.mirror = true;
		setRotation(edge1, 0F, 0F, 0F);
		edge2 = new ModelRenderer(this, 0, 22);
		edge2.addBox(-8F, 0F, -1F, 16, 8, 2);
		edge2.setRotationPoint(0F, 8F, 7F);
		edge2.setTextureSize(64, 128);
		edge2.mirror = true;
		setRotation(edge2, 0F, 0F, 0F);
		floor = new ModelRenderer(this, 0, 32);
		floor.addBox(-8F, 0F, -8F, 16, 8, 16);
		floor.setRotationPoint(0F, 16F, 0F);
		floor.setTextureSize(64, 128);
		floor.mirror = true;
		setRotation(floor, 0F, 0F, 0F);
		edgeInside1 = new ModelRenderer(this, 0, 53);
		edgeInside1.addBox(0F, 0F, -7F, 0, 11, 14);
		edgeInside1.setRotationPoint(-6F, 8F, -1F);
		edgeInside1.setTextureSize(64, 128);
		edgeInside1.mirror = true;
		setRotation(edgeInside1, 0F, 0F, -0.7679449F);
		edgeInside2 = new ModelRenderer(this, 0, 56);
		edgeInside2.addBox(-9F, 0F, 0F, 16, 11, 0);
		edgeInside2.setRotationPoint(1F, 8F, 6F);
		edgeInside2.setTextureSize(64, 128);
		edgeInside2.mirror = true;
		setRotation(edgeInside2, -0.7679449F, 0F, 0F);
	}
