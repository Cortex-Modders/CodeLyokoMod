...
public class BlockIds {
    ...
    public static int LYOKO_STONE_DEFAULT = 1157;
    ...
    public static int LYOKO_ICE_PORTAL_DEFAULT = 1167;
    public static int LYOKO_DESERT_PORTAL_DEFAULT = 1168;
    public static int LYOKO_FOREST_PORTAL_DEFAULT = 1169;
    public static int LYOKO_MOUNTAIN_PORTAL_DEFAULT = 1170;
    public static int LYOKO_CARTHAGE_PORTAL_DEFAULT = 1171;
    public static int LYOKO_URANIUM_ORE_DEFAULT = 1172;
    ...
    public static int LYOKO_ICE_PORTAL;
    public static int LYOKO_DESERT_PORTAL;
    public static int LYOKO_FOREST_PORTAL;
    public static int LYOKO_MOUNTAIN_PORTAL;
    public static int LYOKO_CARTHAGE_PORTAL;
    ...
    public static int LYOKO_TOWER_BASE_FAKE;
}
