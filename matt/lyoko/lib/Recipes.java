...
public class Recipes
{
	...
	{
		GameRegistry.addRecipe(new ItemStack(ModBlocks.Scanner, 1), new Object[] {
    		"###", "#*#", "###", Character.valueOf('#'), Item.ingotGold, Character.valueOf('*'), ModItems.QuantumMatrix
    	});
    	GameRegistry.addRecipe(new ItemStack(ModBlocks.Cable, 12), new Object[] {
    		"###", "$*$", "###", Character.valueOf('#'), Block.cloth, Character.valueOf('*'), Item.ingotGold, Character.valueOf('$'), Item.redstone
    	});
    	GameRegistry.addRecipe(new ItemStack(ModBlocks.SuperCalc, 1), new Object[] {
	...
	public static void registerItemRecipes()
	{
    	...
    	CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ModItems.EmptyCell, 16)," # ", "#*#", " # ",
    			Character.valueOf('*'), Block.glass, Character.valueOf('#'), "ingotTin"));
