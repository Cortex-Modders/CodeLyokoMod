...
{	
    ...
    public LyokoCarthageChunkProvider(World par1World, long par2)
    {
                    ...
                    for (int var30 = 0; var30 < 4; ++var30)
                    {
                        ...
                        for (int var41 = 0; var41 < 8; ++var41)
                        {
                            ...
                            for (int var50 = 0; var50 < 8; ++var50)
                            {
                                ...
                                if (var46 > 0.0D)
                                {
                                    var51 = CodeLyoko.Lyoko_Carthage;
                                }
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        for (int var5 = 0; var5 < 16; ++var5)
        {
            for (int var6 = 0; var6 < 16; ++var6)
            {
                byte var7 = 1;
                int var8 = -1;
                byte var9 = (byte)CodeLyoko.Lyoko_Carthage;
                byte var10 = (byte)CodeLyoko.Lyoko_Carthage;
                ...
                for (int var11 = 127; var11 >= 0; --var11)
                {
                    ...
                    else if (var13 == Block.stone.blockID)
                    {
                        if (var8 == -1)
                        {
                            ...
                            {
                                var9 = 0;
                                var10 = (byte)CodeLyoko.Lyoko_Carthage;
                            }
