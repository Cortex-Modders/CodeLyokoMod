...
public class LyokoDesertChunkProvider implements IChunkProvider
{
	 private Random endRNG;
	    ...
	    public LyokoDesertChunkProvider(World par1World, long par2)
	    {
	    ...
	    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
	    {
	        for (int var5 = 0; var5 < 16; ++var5)
	        {
	            for (int var6 = 0; var6 < 16; ++var6)
	            {
	                byte var7 = 1;
	                int var8 = -1;
	                byte var9 = (byte)CodeLyoko.Lyoko_Sand;
	                byte var10 = (byte)CodeLyoko.Lyoko_Sand;
	                ...
	                for (int var11 = 127; var11 >= 0; --var11)
	                {
	                    ...
	                    else if (var13 == Block.stone.blockID)
	                    {
	                        if (var8 == -1)
	                        {
	                            ...
	                            {
	                                var9 = 0;
	                                var10 = (byte)CodeLyoko.Lyoko_Sand;
	                            }
