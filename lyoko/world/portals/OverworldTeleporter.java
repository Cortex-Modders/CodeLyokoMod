            ...
            for (int var8 = -2; var8 <= 2; ++var8)
            {
                for (int var9 = -2; var9 <= 2; ++var9)
                {
                    for (int var10 = -1; var10 < 3; ++var10)
                    {
                        ...
                        par1World.setBlockWithNotify(var11, var12, var13, var14 ? CodeLyoko.Lyoko_Ice : 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(World par1World, Entity par2Entity)
    {
        ...
        for (int var11 = var9 - var3; var11 <= var9 + var3; ++var11)
        {
            ...
            for (int var14 = var10 - var3; var14 <= var10 + var3; ++var14)
            {
                ...
                {
                    if (par1World.getBlockId(var11, var17, var14) == CodeLyoko.Lyoko_Over_Portal)
                    {
                        while (par1World.getBlockId(var11, var17 - 1, var14) == CodeLyoko.Lyoko_Over_Portal)
                        {
                            --var17;
                        }
        ...
        if (var4 >= 0.0D)
        {
            ...
            if (par1World.getBlockId(var6 - 1, var7, var8) == CodeLyoko.Lyoko_Over_Portal)
            {
                var22 -= 0.5D;
            }
            ...
            if (par1World.getBlockId(var6, var7, var8 - 1) == CodeLyoko.Lyoko_Over_Portal)
            {
                var18 -= 0.5D;
            }
        ...
        for (var20 = 0; var20 < 4; ++var20)
        {
            ...
            for (var21 = 0; var21 < 4; ++var21)
            {
                for (var22 = -1; var22 < 4; ++var22)
                {
                    ...
                    par1World.setBlockWithNotify(var23, var24, var25, var33 ? CodeLyoko.Lyoko_Carthage : CodeLyoko.Lyoko_Over_Portal);
                }
            }
