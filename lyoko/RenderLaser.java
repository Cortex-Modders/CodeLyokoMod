...
{
    public void renderLaser(EntityLaser par1EntityLaser, double par2, double par4, double par6, float par8, float par9)
    {
        this.loadTexture("/item/arrows.png");
        GL11.glPushMatrix();
        GL11.glTranslatef((float)par2, (float)par4, (float)par6);
        GL11.glRotatef(par1EntityLaser.prevRotationYaw + (par1EntityLaser.rotationYaw - par1EntityLaser.prevRotationYaw) * par9 - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(par1EntityLaser.prevRotationPitch + (par1EntityLaser.rotationPitch - par1EntityLaser.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float var21 = (float)par1EntityLaser.arrowShake - par9;
...
/*
    ...
    {
        this.renderLaser((EntityLaser)par1Entity, par2, par4, par6, par8, par9);
    }
}
*/