...
public class ModelScanner extends ModelBase
{
    ...
    public ModelScanner()
    {
        ...
        this.sideLcornerB.addBox(-1F, -4F, -1F, 2, 8, 2);
        ...
        this.sideRcornerB.addBox(-1F, -4F, -1F, 2, 8, 2);
        ...
        this.sideLcornerF.addBox(-1F, -4F, -1F, 2, 8, 2);
        ...
        this.sideRcornerF.addBox(-1F, -4F, -1F, 2, 8, 2);
        ...
        this.sideB.addBox(-8F, -4F, -1F, 16, 8, 2);
        ...
        this.sideL.addBox(-8F, -4F, 0F, 16, 8, 2);
        ...
        this.sideR.addBox(-8F, -4F, 0F, 16, 8, 2);
        ...
        this.doorL.addBox(-1F, -4F, -8F, 2, 8, 8);
        ...
        this.doorR.addBox(-1F, -4F, 0F, 2, 8, 8);
    ...
    @Override
    public void render(Entity entity, float f, float f1, float f2, float modelType, float f4, float f5)
    {
        this.setRotationAngles(f, f1, f2, modelType, f4, f5);
    ...
    public void setRotationAngles(float f, float f1, float f2, float modelType, float f4, float f5)
    {
        if(modelType == 4)
        {
            this.base.rotationPointY = -8F;
            this.baseL.rotationPointY = -8F;
            this.baseB.rotationPointY = -8F;
            this.baseF.rotationPointY = -8F;
            this.baseR.rotationPointY = -8F;
        }
        else if(modelType == 0)
        {
            this.base.rotationPointY = 0.0F;
            this.baseL.rotationPointY = 0.0F;
            this.baseB.rotationPointY = 0.0F;
            this.baseF.rotationPointY = 0.0F;
            this.baseR.rotationPointY = 0.0F;
        }
        else
        {
            //this.sideL.
