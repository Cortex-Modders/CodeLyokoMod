...
public class BlockHolomap extends BlockContainer
{
    ...
    {
        if (access.getBlockId(x - 1, y, z - 1) == ModBlocks.Holomap.blockID && access.getBlockId(x - 1, y, z) == ModBlocks.Holomap.blockID && access.getBlockId(x - 1, y, z + 1) == ModBlocks.Holomap.blockID && access.getBlockId(x, y, z - 1) == ModBlocks.Holomap.blockID && access.getBlockId(x, y, z) == ModBlocks.Holomap.blockID && access.getBlockId(x, y, z + 1) == ModBlocks.Holomap.blockID && access.getBlockId(x + 1, y, z - 1) == ModBlocks.Holomap.blockID && access.getBlockId(x + 1, y, z) == ModBlocks.Holomap.blockID && access.getBlockId(x + 1, y, z + 1) == ModBlocks.Holomap.blockID && clearOnSides(access, x, y, z))
            return true;
        return false;
    }
