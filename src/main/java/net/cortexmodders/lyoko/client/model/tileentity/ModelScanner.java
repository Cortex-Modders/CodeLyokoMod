...
public class ModelScanner extends ModelBase
{
	...
	private static class ModelScannerDoor extends ModelBase
	{
		...
		public ModelScannerDoor()
		{
			...
			this.doorL = new ModelRenderer(this, DEFAULT_TEXTURE_OFFSET_X, DEFAULT_TEXTURE_OFFSET_Y)
			.addBox(-1F, -4F, -8F, 2, 16, 8)
			...
			this.doorR = new ModelRenderer(this, DEFAULT_TEXTURE_OFFSET_X, DEFAULT_TEXTURE_OFFSET_Y)
			.addBox(-1F, -4F, 0F, 2, 16, 8)
			.setTextureSize(128, 128);
